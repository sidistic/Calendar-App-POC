...
if($_SERVER["REQUEST_METHOD"] == "POST")
{
  ...
  $stmt = $conn->prepare("DELETE FROM Events WHERE initiator_id = ? and with_id = ? and type = ? and description = ? and date = ? and time_of_setup = ?");
  ...
  $message = "I will be unavailable to come for \"$type\" on $date for \"$description\" . Thank you.";
