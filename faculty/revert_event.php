...
if($_SERVER["REQUEST_METHOD"] == "POST")
{
  ...
  $stmt = $conn->prepare("UPDATE Events SET status = 0 WHERE initiator_id = ? and with_id = ? and type = ? and description = ? and date = ? and time_of_setup = ?");
  ...
  $message = "I am sorry to inform you that i might not be available to come for \"$type\" on $date for \"$description\" that i had previously accepted. Sorry for inconvienience Regreted.";
