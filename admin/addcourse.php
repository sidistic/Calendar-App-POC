            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    ...
                    <div class="outer-w3-agile col-xl">
                        <button type="button" class="btn btn-primary" style="float: right;" data-toggle="modal" data-target="#adduser">Add new course</button>
                        <!--popup to add user-->
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header text-center">
                <h4 class="modal-title w-100 font-weight-bold">Add New Course</h4>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                </button>
            </div>
            <form method="post" action="add_course_to_db.php">
            <div class="modal-body mx-3">
                ...
                <div class="md-form mb-4">
                    <input type="text" name="title" placeholder="Title" class="form-control validate" required>
                </div>
                <div class="md-form mb-4">
                    <input type="text" name="department" placeholder="Department" class="form-control validate" required>
                </div>
                <div class="md-form mb-4">
