...
<body>
            ...
            <ul class="list-unstyled components">
                ...
                <li>
                    ...
                    <ul class="collapse list-unstyled" id="pageSubmenu4">
                        ...
                        <li>
                            <a href="deleteclubmembers.php">Club Members</a>
                        </li>
                        <li>
        ...
        <div id="content">
            ...
            <nav class="navbar navbar-default mb-xl-5 mb-4">
                <div class="container-fluid">
                    ...
                    <h2 style="text-align:center;">Delete Club Member</h2>
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    ...
                    <div class="outer-w3-agile col-xl">
                        <form method="post" action="del_club_members_in_db.php">
                        <table align="center">
                              <tr>
  ...
  include('db_config.php');
    ...
    $stmt = $conn->prepare("SELECT * FROM ClubMembers order by club_id");
    ...
    { 
      ...
      {
        echo "<tr>
          <td><input type=\"checkbox\" name= \"del_id[]\"value=". $row['club_id'] .",".$row['student_id']."></td>
          <td>". $row['club_id'] ."</td>
  ...
  if(isset($_SESSION['message_to_del_clubmembers']))
  {
    echo $_SESSION['message_to_del_clubmembers'];
    unset($_SESSION['message_to_del_clubmembers']);
  }
   ?>
                        <input type="submit" class="btn btn-primary" style=" width: 20%; display: block; margin: 0 auto;" value="Delete Club Members">
                        </form>
                    </div>
                </div>
            </div>
