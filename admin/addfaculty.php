            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    ...
                    <div class="outer-w3-agile col-xl">
                        <form method="post" action="add_faculty_to_db.php">
                        <table align="center">
                              <tr>
                                <th>Check to add</th>
                                <th>User Id</th>
     ...
     while($row = $result->fetch_assoc())
      { echo "<tr>
          ...
          <td><input type=\"text\" name=\"department". $row['user_id'] ."\"  /></td>
                  ...
                  echo"      </table>
                        <input type=\"submit\" class=\"btn btn-primary\" style=\" width: 20%; display: block; margin: 0 auto;\" value=\"Add Faculty\">
                        </form>";}
                    
                
    if(isset($_SESSION['message_to_add_faculty']))
  {
    echo $_SESSION['message_to_add_faculty'];
    unset($_SESSION['message_to_add_faculty']);
  }
  ?>
                    </div>
                </div>
