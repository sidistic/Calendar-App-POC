...
<body>
        ...
        <div id="content">
            ...
            <div class="container-fluid">
               ...
               <div class="outer-w3-agile col-xl">
                        <form method="post" action="del_course_in_db.php">
                        <table align="center">
                              <tr>
  ...
  include('db_config.php');
    ...
    $result = $stmt->get_result();
        ...
        echo "<tr>
          <td><input type=\"checkbox\" name= \"del_id[]\"value=". $row['course_id'] .",".$row['year'].",".$row['semester']."></td>
          <td>". $row['course_id'] ."</td>
          <td>" . $row['title'] . "</td>
          ...
          <td>" . $row['semester'] . "</td>
                ...
                echo "</table>";
              }if(isset($_SESSION['message_to_del_course']))
  {
    echo $_SESSION['message_to_del_course'];
    unset($_SESSION['message_to_del_course']);
  }
              ?>
                        <input type="submit" class="btn btn-primary" style=" width: 20%; display: block; margin: 0 auto;" value="Delete Courses">
                        </form>
