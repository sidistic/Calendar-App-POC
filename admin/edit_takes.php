        ...
        <div id="content">
            ...
            <nav class="navbar navbar-default mb-xl-5 mb-4">
                <div class="container-fluid">
                    ...
                    <h2 style="text-align:center;">Edit Takes</h2>
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    ...
                    <div class="outer-w3-agile col-xl">
                        <button type="button" class="btn btn-primary" style="float: right;" data-toggle="modal" data-target="#adduser">Edit Takes</button>
                        <!--popup to add user-->
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header text-center">
                <h4 class="modal-title w-100 font-weight-bold">Edit Takes</h4>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                </button>
            </div>
            <form method="post" action="edit_takes_in_db.php">
            <div class="modal-body mx-3">
                ...
                <div class="md-form mb-4">
                    <input type="number" name="faculty_id" placeholder="Faculty id" class="form-control validate" required>
                </div>
                <div class="md-form mb-4">
