...
<body>
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    ...
                    <div class="outer-w3-agile col-xl">
                        <form method="post" action="del_user_in_db.php">
                        <table align="center">
                              <tr>
  ...
  if(isset($_SESSION['message_to_del_user']))
  {
    echo $_SESSION['message_to_del_user'];
    unset($_SESSION['message_to_del_user']);
  }
   ?>  
                        <input type="submit" class="btn btn-primary" style=" width: 20%; display: block; margin: 0 auto;" value="Delete Users">
                        </form>
                    </div>
                </div>
            </div>
