...
<body>
        ...
        <div id="content">
            ...
            <nav class="navbar navbar-default mb-xl-5 mb-4">
                <div class="container-fluid">
                    ...
                    <h2 style="text-align:center;">Delete Faculty</h2>
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    ...
                    <div class="outer-w3-agile col-xl">
                        <form method="post" action="del_faculty_in_db.php">
                        <table align="center">
                              <tr>
  ...
  include('db_config.php');
    ...
    if($result->num_rows > 0)
    {
      ...
      {
        echo "<tr>
          <td><input type=\"checkbox\" name= \"del_id[]\"value=". $row['user_id'] ."></td>
          <td>" . $row['user_id'] . "</td>
  ...
  if(isset($_SESSION['message_to_del_faculty']))
  {
    echo $_SESSION['message_to_del_faculty'];
    unset($_SESSION['message_to_del_faculty']);
  }
   ?>
                        <input type="submit" class="btn btn-primary" style=" width: 20%; display: block; margin: 0 auto;" value="Delete Faculties">
                        </form>
                    </div>
                </div>
            </div>
