...
<body>
  ...
  echo "delete club";
    ...
    {
                      echo"  <form method=\"post\" action=\"del_club_in_db.php\">
                        <table align=\"center\">
                              <tr>
        ...
        echo "<tr>
          <td><input type=\"checkbox\" name= \"del_id[]\"value=". $row['club_id'] ."></td>
          <td>" . $row['club_id'] . "</td>
          <td>" . $row['club_name'] . "</td>
          <td>" . $row['secy_id'] . "</td>
          </tr>";
      ...
      echo "</table>
     <input type=\"submit\" class=\"btn btn-primary\" style=\" width: 20%; display: block; margin: 0 auto;\" value=\"Delete Clubs\">
                        </form>";}
                        ?>
                    </div>
                </div>
