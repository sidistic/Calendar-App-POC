        ...
        <div id="content">
            ...
            <nav class="navbar navbar-default mb-xl-5 mb-4">
                <div class="container-fluid">
                    ...
                    <h2 style="text-align:center;">Add Club</h2>
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    ...
                    <div class="outer-w3-agile col-xl">
                       <button type="button" class="btn btn-primary" style="float: right;" data-toggle="modal" data-target="#adduser">Add new club</button>
                        <!--popup to add user-->
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header text-center">
                <h4 class="modal-title w-100 font-weight-bold">Add New Club</h4>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                </button>
            </div>
            <form method="post" action="add_club_to_db.php">
            <div class="modal-body mx-3">
                ...
                <div class="md-form mb-4">
                    <input type="text" name="club_name" placeholder="Club Name" class="form-control validate" required>
                </div>
                <div class="md-form mb-4">
                    <input type="number" name="secy_id" placeholder="Secy Id" class="form-control validate" required>
                </div>
