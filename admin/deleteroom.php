            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    ...
                    <div class="outer-w3-agile col-xl">
                        <form method="post" action="del_room_in_db.php">
                        <table align="center">
                              <tr>
...
<?php
  ...
  include('db_config.php');
    ...
    if($result->num_rows > 0)
    {
      ...
      {
        echo "<tr>
        <td><input type=\"checkbox\" name=\"del_id[]\" value=".$row['room_no'].",".$row['building']." ></td>
          <td>" . $row['room_no'] . "</td>
          <td>" . $row['building'] . "</td>
          <td>" . $row['capacity'] . "</td>
  ...
  if(isset($_SESSION['message_to_del_room']))
  {
    echo $_SESSION['message_to_del_room'];
    unset($_SESSION['message_to_del_room']);
  }
   ?>
                        <input type="submit" class="btn btn-primary" style=" width: 20%; display: block; margin: 0 auto;" value="Delete Rooms">
                        </form>
                    </div>
                </div>
            </div>
