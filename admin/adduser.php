            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    ...
                    <div class="outer-w3-agile col-xl">
                        ...
                        <button type="button" class="btn btn-primary" style="float: right;" data-toggle="modal" data-target="#adduser">Add new user</button>
                        <!--popup to add user-->
...
<div class="modal fade" id="adduser" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" style="display: none;">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <form method="post" action="add_user_to_db.php">
            <div class="modal-body mx-3">
                <div class="md-form mb-4">
                    <input type="number" name="user_id" placeholder="User Id" class="form-control validate" required>
                </div>

                <div class="md-form mb-4">
                    <input type="text" name="uname" placeholder="User Name" class="form-control validate" required>
                </div>
                <div class="md-form mb-4">
                    <input type="text" name="pass" placeholder="Password" class="form-control validate" required>
                </div>
...
<?php
  ...
  include('db_config.php');
    ...
    $stmt = $conn->prepare("SELECT * FROM User WHERE not user_id = ?");
    ...
    if(isset($_SESSION['message_to_add_user']))
  {
    echo $_SESSION['message_to_add_user'];
    unset($_SESSION['message_to_add_user']);
  }
