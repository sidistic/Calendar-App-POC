    ...
    echo $username ;?></a>
                    ...
                    <div class="inbox-topr col-6">
                        <ul class="right d-flex justify-content-end">
                            <li> Compose New Message
                                <a href="#" onclick="document.getElementById('myPopup').style.display='block'" >
                                        ...
                                        <div class="container-contact1" >
                                            ...
                                            <form class="contact1-form validate-form">
                                                ...
                                                <div class="wrap-input1 validate-input" data-validate = "Name is required">
                                                    <input class="input1" type="text" name="name" placeholder="Reciever's User name">
            ...
            <div class="container-fluid">
                <div class="row">
                    ...
                    <ul>
                        <div class="index-rcontent col-xl-12 mt-xl-0 mt-3">
                            <?php
