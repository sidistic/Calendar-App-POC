        ...
        <div id="content">
            ...
            <nav class="navbar navbar-default mb-xl-5 mb-4">
                <div class="container-fluid">
                    ...
                    <h2 style="text-align:center;">Add Club Member</h2>
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    ...
                    <div class="outer-w3-agile col-xl">
                        <button type="button" class="btn btn-primary" style="float: right;" data-toggle="modal" data-target="#adduser">Add new club member</button>
                        <!--popup to add user-->
...
<div class="modal fade" id="adduser" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" style="display: none;">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header text-center">
                <h4 class="modal-title w-100 font-weight-bold">Add New Club Member</h4>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                </button>
            </div>
            <form method="post" action="add_club_member_to_db.php">
            <div class="modal-body mx-3">
                <div class="md-form mb-4">
                    <input type="number" name="club_id" placeholder="Club Id" class="form-control validate" required>
                </div>
                <div class="md-form mb-4">
                    <input type="number" name="student_id" placeholder="Student Id" class="form-control validate" required>
                </div>
  ...
  echo "mama";
    ...
    $stmt = $conn->prepare("SELECT * FROM ClubMembers");
...
?>
  ...
  <?php
  if(isset($_SESSION['message_to_add_club_member']))
  {
    echo $_SESSION['message_to_add_club_member'];
    unset($_SESSION['message_to_add_club_member']);
  }
