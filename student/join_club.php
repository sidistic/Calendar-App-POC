            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    ...
                    <div class="outer-w3-agile col-xl">
                      <center>  <form action="enroll_student_to_club.php" method="post">
                        
  <select style="width: auto !important;
    min-width: 120px;"name="club" id="time_slot_end" class="custom-select">
    <?php
      ...
      <input type = "submit" class="btn btn-primary" value = "Join Club">
    </form></center>
</div>
